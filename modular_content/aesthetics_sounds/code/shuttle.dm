/obj/docking_port/mobile
	...
	var/custom_hyperspace_warmup_sound = 'modular_content/aesthetics_sounds/sound/shuttle/hyperspace_mini.ogg'
	/// Custom sound for shuttle's HYPERSPACE_END. Doesn't include emergency & arrival shuttles
	var/custom_hyperspace_end_sound = 'modular_content/aesthetics_sounds/sound/shuttle/hyperspace_end_new.ogg'
