/datum/sound_effect/male_sigh
	file_paths = list(
		...
		'modular_content/emote_panel/audio/human/male/sigh_male.ogg',
	)
...
/datum/emote/living/sniffle/get_sound(mob/living/user)
	if(user.gender == FEMALE)
		return 'modular_content/emote_panel/audio/human/female/sniff_female.ogg'
	else
		return 'modular_content/emote_panel/audio/human/male/sniff_male.ogg'
...
/datum/emote/living/gasp/get_sound(mob/living/user)
	...
	if(human_user.physique == FEMALE)
		return pick(
			...
			'modular_content/emote_panel/audio/human/female/gasp_female_1.ogg',
			'modular_content/emote_panel/audio/human/female/gasp_female_2.ogg',
			'modular_content/emote_panel/audio/human/female/gasp_female_3.ogg',
			'modular_content/emote_panel/audio/human/female/gasp_female_4.ogg',
		)
	return pick(
		'sound/mobs/humanoids/human/gasp/gasp_male1.ogg',
		'sound/mobs/humanoids/human/gasp/gasp_male2.ogg',
		'modular_content/emote_panel/audio/human/male/gasp_male_1.ogg',
		'modular_content/emote_panel/audio/human/male/gasp_male_2.ogg',
		'modular_content/emote_panel/audio/human/male/gasp_male_3.ogg',
		'modular_content/emote_panel/audio/human/male/gasp_male_4.ogg',
		'modular_content/emote_panel/audio/human/male/gasp_male_5.ogg',
	)
...
/datum/emote/living/yawn/get_sound(mob/living/user)
	...
	if(human_user.physique == FEMALE)
		return pick(
			'modular_content/emote_panel/audio/human/female/yawn_female_1.ogg',
			'modular_content/emote_panel/audio/human/female/yawn_female_2.ogg',
			'modular_content/emote_panel/audio/human/female/yawn_female_3.ogg',
		)
	return pick(
		'modular_content/emote_panel/audio/human/male/yawn_male_1.ogg',
		'modular_content/emote_panel/audio/human/male/yawn_male_2.ogg',
	)
...
/datum/emote/living/choke/get_sound(mob/living/user)
	...
	if(human_user.physique == FEMALE)
		return pick(
			'modular_content/emote_panel/audio/human/female/choke_female_1.ogg',
			'modular_content/emote_panel/audio/human/female/choke_female_2.ogg',
			'modular_content/emote_panel/audio/human/female/choke_female_3.ogg',
		)
	return pick(
		'modular_content/emote_panel/audio/human/male/choke_male_1.ogg',
		'modular_content/emote_panel/audio/human/male/choke_male_2.ogg',
		'modular_content/emote_panel/audio/human/male/choke_male_3.ogg',
	)

/datum/emote/living/carbon/whistle/get_sound(mob/living/user)
	return pick(
		'sound/mobs/humanoids/human/whistle/whistle1.ogg',
		'modular_content/emote_panel/audio/whistle.ogg',
	)
...
/datum/emote/living/carbon/moan/get_sound(mob/living/user)
	...
	if(human_user.physique == FEMALE)
		return pick(
			'modular_content/emote_panel/audio/human/female/moan_female_1.ogg',
			'modular_content/emote_panel/audio/human/female/moan_female_2.ogg',
			'modular_content/emote_panel/audio/human/female/moan_female_3.ogg',
		)
	return pick(
		'modular_content/emote_panel/audio/human/male/moan_male_1.ogg',
		'modular_content/emote_panel/audio/human/male/moan_male_2.ogg',
