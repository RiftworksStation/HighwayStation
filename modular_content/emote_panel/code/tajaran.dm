/datum/species/tajaran/get_scream_sound(mob/living/carbon/human/tajaran)
	if(tajaran.physique == FEMALE)
		return 'modular_content/emote_panel/audio/tajaran/tajaran_scream.ogg'
	return 'modular_content/emote_panel/audio/tajaran/tajaran_scream.ogg'
...
/datum/species/tajaran/get_sneeze_sound(mob/living/carbon/human/tajaran)
	if(tajaran.physique == FEMALE)
		return pick(
			'modular_content/emote_panel/audio/tajaran/tajaran_sneeze_female1.ogg',
			'modular_content/emote_panel/audio/tajaran/tajaran_sneeze_female2.ogg',
		)
	return 'modular_content/emote_panel/audio/tajaran/tajaran_sneeze_male.ogg'
...
/datum/emote/living/carbon/human/tajaran/emote_meow
	...
	vary = TRUE
	cooldown = 4 SECONDS
	sound = 'modular_content/emote_panel/audio/tajaran/tajaran_meow.ogg'
...
/datum/emote/living/carbon/human/tajaran/emote_mow
	...
	vary = TRUE
	cooldown = 4 SECONDS
	sound = 'modular_content/emote_panel/audio/tajaran/tajaran_annoyed_meow.ogg'
...
/datum/emote/living/carbon/human/tajaran/emote_purr
	...
	emote_type = EMOTE_AUDIBLE | EMOTE_VISIBLE
	cooldown = 4 SECONDS
	sound = 'modular_content/emote_panel/audio/tajaran/tajaran_purr.ogg'
...
/datum/emote/living/carbon/human/tajaran/emote_pur
	...
	emote_type = EMOTE_AUDIBLE | EMOTE_VISIBLE
	cooldown = 4 SECONDS
	sound = 'modular_content/emote_panel/audio/tajaran/tajaran_purr_short.ogg'
...
/datum/emote/living/carbon/human/tajaran/emote_purrr
	...
	emote_type = EMOTE_AUDIBLE | EMOTE_VISIBLE
	cooldown = 4 SECONDS
	sound = 'modular_content/emote_panel/audio/tajaran/tajaran_purr_long.ogg'
...
/datum/emote/living/carbon/human/tajaran/emote_hiss_t
	...
	emote_type = EMOTE_AUDIBLE | EMOTE_VISIBLE
	cooldown = 4 SECONDS
	sound = 'modular_content/emote_panel/audio/tajaran/tajaran_hiss.ogg'
