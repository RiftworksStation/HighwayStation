...
/datum/security_level/gamma
	...
	sound = 'modular_content/security_levels/sound/new_siren.ogg'
...
/datum/security_level/epsilon
	...
	sound = 'modular_content/security_levels/sound/epsilon.ogg'
...
/datum/security_level/epsilon/pre_set_security_level()
	...
	sound_to_playing_players('modular_content/aesthetics_sounds/sound/powerloss.ogg', 70)
	power_fail(set_delay, set_delay)
	// Repurposes AI to serve CentCom
	var/notice_sound = sound('modular_content/aesthetics_sounds/sound/epsilon_laws.ogg')
