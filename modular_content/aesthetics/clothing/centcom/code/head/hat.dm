/obj/item/clothing/head/hats/centcom_cap
	...
	icon = 'modular_content/aesthetics/clothing/centcom/icons/obj/clothing/head/hats.dmi'
	worn_icon = 'modular_content/aesthetics/clothing/centcom/icons/mob/clothing/head/hats.dmi'
