...
/datum/mod_theme/corporate
	...
	variants = list(
		"corporate" = list(
			MOD_ICON_OVERRIDE = 'modular_content/aesthetics/clothing/centcom/icons/obj/clothing/modsuit/mod_clothing.dmi',
			MOD_WORN_ICON_OVERRIDE = 'modular_content/aesthetics/clothing/centcom/icons/mob/clothing/modsuit/mod_clothing.dmi',
