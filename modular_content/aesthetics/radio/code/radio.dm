/obj/item/radio/headset
	icon = 'modular_content/aesthetics/radio/icons/obj/headsets.dmi'
	worn_icon = 'modular_content/aesthetics/radio/icons/mob/ears.dmi'

// MARK: TSF
/obj/item/radio/headset/heads/captain/alt/tsf
	name = "TSF's bowman headset"
