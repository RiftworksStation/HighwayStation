/obj/item/gun/energy/laser/awaymission_aeg
	...
	icon = 'modular_content/weapon/icons/ranged/energy.dmi'
	icon_state = "laser_gate"
	lefthand_file = 'modular_content/weapon/icons/ranged/inhands/energy/lefthand.dmi'
	righthand_file = 'modular_content/weapon/icons/ranged/inhands/energy/righthand.dmi'
