/obj/item/gun/ballistic/automatic/cm5
	...
	fire_sound = 'modular_content/weapon/sound/ranged/cm5.ogg'
	can_suppress = TRUE
	burst_size = 1
	...
	load_sound = 'modular_content/weapon/sound/ranged/cm5_reload.ogg'
	load_empty_sound = 'modular_content/weapon/sound/ranged/cm5_reload.ogg'
	eject_sound = 'modular_content/weapon/sound/ranged/cm5_unload.ogg'
	eject_empty_sound = 'modular_content/weapon/sound/ranged/cm5_unload.ogg'
