/obj/item/gun/ballistic/automatic/cm82
	...
	fire_sound = 'modular_content/weapon/sound/ranged/cm82.ogg'
	suppressed_sound = 'modular_content/weapon/sound/ranged/suppressed_rifle.ogg'
	can_suppress = TRUE
	...
	load_sound = 'modular_content/weapon/sound/ranged/cm82_reload.ogg'
	load_empty_sound = 'modular_content/weapon/sound/ranged/cm82_reload.ogg'
	eject_sound = 'modular_content/weapon/sound/ranged/cm82_unload.ogg'
	eject_empty_sound = 'modular_content/weapon/sound/ranged/cm82_unload.ogg'
	rack_sound = 'modular_content/weapon/sound/ranged/ar_cock.ogg'
