/obj/item/mounted_machine_gun_folded
	...
	icon = 'modular_content/weapon/icons/ranged/turret_objects.dmi'
...
/obj/machinery/deployable_turret/mounted_machine_gun
	...
	icon = 'modular_content/weapon/icons/ranged/turret.dmi'
	icon_state = "mmg"
	base_icon_state = "mmg"
	max_integrity = 250
	...
	rate_of_fire = 2
	firesound = 'modular_content/weapon/sound/ranged/50cal_box_01.ogg'
