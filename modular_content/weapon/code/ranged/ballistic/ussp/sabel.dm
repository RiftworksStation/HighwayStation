...
/obj/item/gun/ballistic/automatic/sabel
	...
	icon_state = "amk_civ"
	lefthand_file = 'modular_content/weapon/icons/ranged/inhands/ballistic/lefthand.dmi'
	righthand_file = 'modular_content/weapon/icons/ranged/inhands/ballistic/righthand.dmi'
	inhand_icon_state = "amk_civ"
	fire_sound = 'modular_content/weapon/sound/ranged/amk_fire.ogg'
	worn_icon = 'modular_content/weapon/icons/ranged/guns_back.dmi'
	rack_sound = 'modular_content/weapon/sound/ranged/ltrifle_cock.ogg'
	load_sound = 'modular_content/weapon/sound/ranged/ltrifle_magin.ogg'
	load_empty_sound = 'modular_content/weapon/sound/ranged/ltrifle_magin.ogg'
	eject_sound = 'modular_content/weapon/sound/ranged/ltrifle_magout.ogg'
	suppressed_sound = 'modular_content/weapon/sound/ranged/heavy_shot_suppressed.ogg'
	burst_size = 1
...
/obj/item/gun/ballistic/automatic/sabel/auto/gauss
	...
	worn_icon_state = "amk"
	suppressed_sound = 'modular_content/weapon/sound/ranged/suppressed_heavy.ogg'
...
/obj/item/gun/ballistic/automatic/sabel/auto/gauss/process_fire(atom/target, mob/living/user, message = TRUE, params = null, zone_override = "", bonus_spread = 0)
	...
	if(chambered.loaded_projectile && gauss_mode)
		...
		fire_sound = 'modular_content/weapon/sound/ranged/laser1.ogg'
