...
/obj/item/bodypart/arm/left/robot/surplus/hephaestus_titan
	...
	icon_static = 'modular_content/augmentation_preferences/icons/hephaestus_titan_augments.dmi'
	icon = 'modular_content/augmentation_preferences/icons/hephaestus_titan_augments.dmi'
