...
/obj/item/bodypart/arm/left/robot/surplus/wardtakahashi_pro
	...
	icon_static = 'modular_content/augmentation_preferences/icons/wardtakahashi_pro_augments.dmi'
	icon = 'modular_content/augmentation_preferences/icons/wardtakahashi_pro_augments.dmi'
