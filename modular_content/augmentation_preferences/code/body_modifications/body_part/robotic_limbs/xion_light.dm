...
/obj/item/bodypart/arm/left/robot/surplus/xion_light
	...
	icon_static = 'modular_content/augmentation_preferences/icons/xion_light_augments.dmi'
	icon = 'modular_content/augmentation_preferences/icons/xion_light_augments.dmi'
