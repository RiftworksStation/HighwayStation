// MARK: Banners
/obj/item/banner
	icon = 'modular_content/objects/icons/obj/items/banner.dmi'
	lefthand_file = 'modular_content/objects/icons/mob/inhands/banners_lefthand.dmi'
	righthand_file = 'modular_content/objects/icons/mob/inhands/banners_righthand.dmi'
