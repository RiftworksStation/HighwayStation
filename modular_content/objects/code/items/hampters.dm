/obj/item/toy/plush/hampter
	...
	icon = 'modular_content/objects/icons/obj/items/hampter.dmi'
	icon_state = "hampter"
	lefthand_file = 'modular_content/objects/icons/mob/inhands/hampter_lefthand.dmi'
	righthand_file = 'modular_content/objects/icons/mob/inhands/hampter_righthand.dmi'
	inhand_icon_state = "hampter"
	worn_icon = 'modular_content/objects/icons/mob/clothing/head/hampter.dmi'
