...
/datum/instrument/guitar/soundhand_rock
	...
	id = "cshrockgt"
	real_samples = list("36"='modular_content/objects/sounds/guitar/soundhand_rock/c2.ogg',
				"48"='modular_content/objects/sounds/guitar/soundhand_rock/c3.ogg',
				"60"='modular_content/objects/sounds/guitar/soundhand_rock/c4.ogg',
				"72"='modular_content/objects/sounds/guitar/soundhand_rock/c5.ogg')

/datum/instrument/guitar/soundhand_metal
	name = "Soundhand Metal Guitar"
	id = "cshmetalgt"
	real_samples = list("36"='modular_content/objects/sounds/guitar/soundhand_metal/c2.ogg',
				"48"='modular_content/objects/sounds/guitar/soundhand_metal/c3.ogg',
				"60"='modular_content/objects/sounds/guitar/soundhand_metal/c4.ogg',
				"72"='modular_content/objects/sounds/guitar/soundhand_metal/c5.ogg')

/datum/instrument/guitar/soundhand_bass
	name = "Soundhand Bass Guitar"
	id = "cshbassgt"
	real_samples = list("36"='modular_content/objects/sounds/guitar/soundhand_bass/c2.ogg',
				"48"='modular_content/objects/sounds/guitar/soundhand_bass/c3.ogg',
				"60"='modular_content/objects/sounds/guitar/soundhand_bass/c4.ogg',
				"72"='modular_content/objects/sounds/guitar/soundhand_bass/c5.ogg')
...
/obj/item/instrument/soundhand_metal_guitar
	...
	icon = 'modular_content/objects/icons/obj/items/samurai_guitar.dmi'
	w_class = WEIGHT_CLASS_NORMAL
	lefthand_file = 'modular_content/objects/icons/mob/inhands/samurai_guitar_lefthand.dmi'
	righthand_file = 'modular_content/objects/icons/mob/inhands/samurai_guitar_righthand.dmi'
