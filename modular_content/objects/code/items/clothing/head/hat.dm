...
/obj/item/clothing/head/cowboy/roboticist
	...
	icon = 'modular_content/objects/icons/obj/clothing/head/cowboy.dmi'
	worn_icon = 'modular_content/objects/icons/mob/clothing/head/cowboy.dmi'
...
/obj/item/clothing/head/caphat/beret_black
	...
	icon = 'modular_content/objects/icons/obj/clothing/head/hats.dmi'
	worn_icon = 'modular_content/objects/icons/mob/clothing/head/cap.dmi'
...
/obj/item/clothing/head/ratge
	...
	desc = "Ну ты и крыса!"
	icon = 'modular_content/objects/icons/obj/clothing/head/hats.dmi'
	worn_icon = 'modular_content/objects/icons/mob/clothing/head/hats.dmi'
