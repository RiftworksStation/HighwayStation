/datum/mod_theme/ussp_standart
	...
	activation_sound = 'modular_content/objects/sounds/mod_activation/mod_nominal_ru.ogg'
	...
	variants = list(
		"ussp_standart" = list(
			MOD_ICON_OVERRIDE = 'modular_content/objects/icons/obj/clothing/modsuit/mod_clothing.dmi',
			MOD_WORN_ICON_OVERRIDE = 'modular_content/objects/icons/mob/clothing/modsuit/mod_clothing.dmi',
