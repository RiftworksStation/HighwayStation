/obj/item/clothing/suit/hooded/wintercoat/science/robotics/alt
	...
	icon = 'modular_content/objects/icons/obj/clothing/suits/wintercoat.dmi'
	worn_icon = 'modular_content/objects/icons/mob/clothing/suits/wintercoat.dmi'
	hoodtype = NONE
...
/obj/item/clothing/head/hooded/winterhood/blueshield
	...
	icon = 'modular_content/objects/icons/obj/clothing/head/winterhood.dmi'
	worn_icon = 'modular_content/objects/icons/mob/clothing/head/winterhood.dmi'
