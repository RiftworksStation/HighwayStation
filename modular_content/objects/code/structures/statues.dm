...
/obj/structure/statue/station_map/cyberiad
	...
	icon = 'modular_content/objects/icons/obj/structures/cyberiad.dmi'
...
/obj/structure/statue/station_map/delta
	...
	icon = 'modular_content/objects/icons/obj/structures/delta.dmi'
...
/obj/structure/statue/dummy
	name = "Unknown"
	desc = null
	icon = 'modular_content/mobs/icons/dummies.dmi'
	icon_state = null
	pixel_y = 7
	anchored = TRUE
	max_integrity = 1000
