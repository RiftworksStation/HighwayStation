...
/obj/item/stack/tile/wood
	icon = 'modular_content/objects/icons/turf/wooden/tiles.dmi'
	icon_state = "tile-wood"
	color = COLOR_WOOD

/turf/open/floor/wood
	icon = 'modular_content/objects/icons/turf/wooden/wooden.dmi'
	icon_state = "wood"
	damaged_dmi = 'modular_content/objects/icons/turf/wooden/wooden.dmi'
	color = COLOR_WOOD
