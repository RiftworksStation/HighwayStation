/mob/living/basic/mouse
	icon = 'modular_content/mobs/icons/mouse.dmi' // Здесь есть недостающие стейты
	icon_resting = "mouse_gray_rest"
	attack_sound = 'modular_content/mobs/sound/rat_squeak.ogg'
	death_sound = 'modular_content/mobs/sound/rat_death.ogg'
	damaged_sounds = list('modular_content/mobs/sound/rat_wound.ogg')
...
/mob/living/basic/mouse/wooly
	...
	body_color = "wooly"
	icon = 'modular_content/mobs/icons/mouse.dmi'
