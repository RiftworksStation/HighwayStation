/mob/living/basic/pet/dog
	...
	death_sound = 'modular_content/mobs/sound/dog_yelp.ogg'
	damaged_sounds = list('modular_content/mobs/sound/dog_yelp.ogg')
	var/list/growl_sounds = list('modular_content/mobs/sound/dog_grawl1.ogg','modular_content/mobs/sound/dog_grawl2.ogg') //Used in emote.
...
/mob/living/basic/pet/dog/tamaskan
	...
	icon = 'modular_content/mobs/icons/pets.dmi'
	icon_state = "tamaskan"
