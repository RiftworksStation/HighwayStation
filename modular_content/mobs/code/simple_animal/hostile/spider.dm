...
/mob/living/basic/spider
	death_sound = 'modular_content/mobs/sound/spider_death.ogg'
	damaged_sounds = list('modular_content/mobs/sound/spider_attack1.ogg', 'modular_content/mobs/sound/spider_attack2.ogg')
	attack_verb_continuous = "вгрызается"
	attack_verb_simple = "кусает"
	response_help_continuous = "лапает"
