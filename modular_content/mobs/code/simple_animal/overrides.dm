...
/mob/living/basic/mining/legion
	death_sound = 'modular_content/mobs/sound/legion_death.ogg'

/mob/living/basic/mining/legion/death(gibbed)
	for(var/area/lavaland/L in world)
		SEND_SOUND(L, sound('modular_content/mobs/sound/legion_death_far.ogg'))
	. = ..()

/* Nar Sie */
/obj/narsie/Initialize(mapload)
	. = ..()
	SEND_SOUND(world, sound('modular_content/mobs/sound/narsie_rises.ogg'))
