...
#define RADIAL_CLEAR image(icon = 'modular_content/bar_hookahs/icons/radial.dmi', icon_state = "eject")
#define RADIAL_EXTINGUISH image(icon = 'modular_content/bar_hookahs/icons/radial.dmi', icon_state = "extinguish")
#define RADIAL_BLOW image(icon = 'modular_content/bar_hookahs/icons/radial.dmi', icon_state = "blow")
...
/obj/item/hookah
	...
	icon = 'modular_content/bar_hookahs/icons/hookah.dmi'
	icon_state = "hookah"
	max_integrity = 50
	integrity_failure = 0
