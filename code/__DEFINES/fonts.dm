...
/// Emoji icon set
#define EMOJI_SET 'modular_content/aesthetics/emoji/icons/emoji220.dmi'	// BANDASTATION EDIT: Original - #define EMOJI_SET 'icons/ui/chat/emoji.dmi' // TODO_MODULAR: make it somehow combine with upstream?
