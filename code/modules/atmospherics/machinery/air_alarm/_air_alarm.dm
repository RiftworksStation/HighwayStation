...
/obj/machinery/airalarm/Initialize(mapload)
	...
	if(name == initial(name))
		ru_names_rename(ru_names_toml(src::name, suffix = " ([get_area_name(src)])", override_base = "[get_area_name(src)] Air Alarm"))
...
/obj/machinery/airalarm/update_name(updates)
	. = ..()
	ru_names_rename(ru_names_toml(src::name, suffix = " ([get_area_name(my_area)])", override_base = "[get_area_name(my_area)] Air Alarm"))
